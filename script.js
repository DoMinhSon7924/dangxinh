...
let guideOpen=false
helpBtn.onclick=()=>{guideOpen=true;helpOverlay.style.display='flex'}
helpClose.onclick=()=>{guideOpen=false;helpOverlay.style.display='none'}
helpOverlay.onclick=e=>{if(e.target===helpOverlay){guideOpen=false;helpOverlay.style.display='none'}}
